    ...
    <div class="col-md-6 mx-auto">
      <div class="card card-body mt-5">
        ...
        <form action="<?php echo URLROOT; ?>/users/register" method="post">
          ...
          <div class="form-group">
            <label for="confirm_password">Confirm Password <span class="text-danger font-weight-bold">*</span></label>
          ...
          <div class="row">
            ...
            <div class="col">
              <a href="<?php echo URLROOT; ?>/users/login" class="btn btn-light bt-block">Have an account? Login</a>
            </div>
          </div>
        </form>
      </div>
